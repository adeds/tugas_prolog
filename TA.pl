%klas(Nama,akar,batang,daun,bunga).
...
write(A);
	    ...
	    Pili = 3 -> tumbuhan,abort;

	write('Inputan Salah')),spermatophyta.




tumbuhan:- nl,nl,
	write('       PROGRAM SEDERHANA       '),nl,
	...
	spesies(A,rizoid,ada_semacam_batang,belum_ada_mesofil,tidak_ada),
	    ...
	    Pil = 2 ->  klas(pterido,Akar,Batang,Daun,Bunga),
	write('Akar = '),write(Akar),nl,
	write('batang = '),write(Batang),nl,
	write('daun = '),write(Daun),nl,
	write('bunga = '),write(Bunga),nl,
